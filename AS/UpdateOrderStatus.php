...
// Check if the form to update status and address is submitted
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $newStatus = $_POST['status'];
    $newAddress = $_POST['shippingAddress'];

    // Update the order status and shipping address in the database
    $updateSql = "UPDATE `order` SET Status = ?, ShippingAddress = ? WHERE OrderID = ?";
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        <!-- Status and Address Update Form -->
                        <form method="POST" action="">
                            ...
                            <p><strong>Shipping Address:</strong>
                                <input type="text" name="shippingAddress" class="form-control" value="<?php echo htmlspecialchars($order['ShippingAddress']); ?>" required>
                            </p>

                            <button type="submit" class="btn btn-primary mt-2">Update Status & Address</button>
                        </form>
