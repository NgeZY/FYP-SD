            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Mostly Sold Products</h4>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Sales (Items Sold)</th>
                                <th scope="col">Earnings (RM)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            // Query to fetch the top 4 mostly sold products
                            $sql = "
                                SELECT 
                                    p.ProductName, 
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>RM " . number_format($row['Earnings'], 2) . "</td>";
                                    echo "</tr>";
                                }
                            } else {
