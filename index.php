...
<head>
    ...
    <link href="CG/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="CG/css/style.css" rel="stylesheet">
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden">
                        <a href="CG/mainpage.php?category=Shirts" class="nav-item nav-link">Shirts</a>
                        <a href="CG/mainpage.php?category=Blazers" class="nav-item nav-link">Blazers</a>
                        <a href="CG/mainpage.php?category=Accessories" class="nav-item nav-link">Accessories</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
							...
							<a href="CG/Viewhistoryorder.php" class="nav-item nav-link">Purchase History</a>
                        </div>
        ...
        <div class="row px-xl-5 pb-3">
			...
			if (mysqli_num_rows($result) > 0) {
    			while ($row = mysqli_fetch_assoc($result)) {
        			...
        			echo '        <a href="CG/detail.php?id=' . $row['ProductID'] . '" class="cat-img position-relative overflow-hidden mb-3">';
            ...
            <div class="col">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <a href="CG/mainpage.php" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row px-xl-5 pb-3">
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '            <a href="CG/detail.php?id=' . $row['ProductID'] . '" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>'; // Link to product details
                    echo '        </div>';
                    echo '    </div>';
                    echo '</div>';
                }
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark mb-2" href="CG/about.php"><i class="fa fa-angle-right mr-2"></i>About Us</a>
                            <a class="text-dark mb-2" href="CG/contact.php"><i class="fa fa-angle-right mr-2"></i>Contact Us</a>
                        </div>
                    </div>
